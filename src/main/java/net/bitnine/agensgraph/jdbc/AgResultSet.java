...
public class AgResultSet implements ResultSet {
    ...
    AgResultSet(ResultSet rs) throws SQLException {
        this.rs = rs.unwrap(PgResultSet.class);
        this.conn = rs.getStatement().getConnection().unwrap(PgConnection.class);
    }
    ...
    public String getString(int columnIndex) throws SQLException {
        ...
        if (oid == Oid.JSONB) {
            ...
            String s = j.tryGetString();
            if (s == null) {
                // other types, print them AS-IS
                s = j.getValue();
            }

            try {
                return conn.getEncoding().decode(s.getBytes());
            } catch (IOException e) {
    ...
    public String getString(String columnLabel) throws SQLException {
        return getString(rs.findColumn(columnLabel));
    }

    @Override
    public boolean getBoolean(String columnLabel) throws SQLException {
        return getBoolean(rs.findColumn(columnLabel));
    }
    ...
    public short getShort(String columnLabel) throws SQLException {
        return getShort(rs.findColumn(columnLabel));
    }

    @Override
    public int getInt(String columnLabel) throws SQLException {
        return getInt(rs.findColumn(columnLabel));
    }

    @Override
    public long getLong(String columnLabel) throws SQLException {
        return getLong(rs.findColumn(columnLabel));
    }

    @Override
    public float getFloat(String columnLabel) throws SQLException {
        return getFloat(rs.findColumn(columnLabel));
    }

    @Override
    public double getDouble(String columnLabel) throws SQLException {
        return getDouble(rs.findColumn(columnLabel));
    }

    @Override
    public BigDecimal getBigDecimal(String columnLabel, int scale) throws SQLException {
        return getBigDecimal(rs.findColumn(columnLabel), scale);
    }
    ...
    public BigDecimal getBigDecimal(String columnLabel) throws SQLException {
        return getBigDecimal(rs.findColumn(columnLabel));
    }
    ...
    public Statement getStatement() throws SQLException {
        return new AgStatement(rs.getStatement());
    }
    ...
    public <T> T unwrap(Class<T> iface) throws SQLException {
        ResultSet rs;
        if (iface.equals(AgResultSet.class))
            rs = this;
        else
            rs = this.rs;

        if (iface.isAssignableFrom(rs.getClass())) {
            return iface.cast(rs);
        } else {
    ...
    public boolean isWrapperFor(Class<?> iface) throws SQLException {
        ...
        return iface.isAssignableFrom(rs.getClass());
    }
}
