...
public class AgArray extends PgArray {
    ...
    private void buildArrayList() throws SQLException {
        ...
        AgTokenizer t = new AgTokenizer(fieldString);
    ...
    private Object buildArray(ArrayList<String> input, int index, int count) throws SQLException {
        ...
        if (oid == Oid.EDGE_ARRAY) {
            ...
            // other oids not currently supported
            connection.getLogger().log(Level.FINEST, "getArrayImpl(long,int,Map) with {0}", getBaseType());
